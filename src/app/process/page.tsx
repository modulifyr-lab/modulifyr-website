            ...
            {steps.map((step, idx) => (
              <div key={idx} className="group flex flex-col gap-12 lg:flex-row">
                <div className="flex flex-col gap-4 lg:w-1/3">
                  ...
                  <div className="text-brand-teal flex items-center gap-2 text-sm font-semibold tracking-widest uppercase">
                    <Clock className="h-4 w-4" /> {step.duration}
                  </div>
                  <p className="text-text-secondary leading-relaxed">{step.desc}</p>
                </div>

                <div className="border-border-base rounded-3xl border bg-white p-8 shadow-sm transition-shadow group-hover:shadow-md lg:w-2/3">
                  <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                    <div className="flex flex-col gap-4">
                      ...
                      <div className="text-text-muted mt-auto flex items-center gap-2 text-xs italic">
