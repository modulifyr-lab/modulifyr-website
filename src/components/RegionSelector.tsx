  ...
  return (
    <label className="text-text-muted flex items-center gap-2 text-xs font-semibold">
      ...
      <select
        ...
        className="border-border-base bg-background text-brand-navy focus-visible:outline-brand-orange dark:text-foreground rounded-lg border px-2 py-2 text-xs font-bold focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2"
      >
