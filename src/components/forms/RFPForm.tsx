                      ...
                      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 md:grid-cols-3">
                        {budgets.map((b) => (
                          <button
                            ...
                            className={`cursor-pointer rounded-xl border px-3 py-3 text-left text-xs font-semibold transition-all ${form.budget === b ? "border-brand-orange bg-brand-orange/5 text-brand-orange" : "border-border-base bg-bg-light text-text-secondary hover:border-brand-navy"}`}
                          >
                            {b}
                          </button>
                        ))}
                  ...
                  {[
                    {
                      step: "01",
                      title: "Review",
                      desc: "We read every submission carefully and research your organization.",
                    },
                    {
                      step: "02",
